                ...
                <div class="col-md-8 col-md-offset-2 text-center">
                    <div class="display-t">
                        <div class="display-tc animate-box" data-animate-effect="fadeIn">
                            <h1>Aprenda a Trabalhar com o <span style="color: #f4645f">FrameWork PHP</span> mais utilizado
                                do Mundo</h1>
                            <h2>Com a metodologia e certificado da <a href="https://www.upinside.com.br"
                                    target="_blank">UpInside Treinamentos</a></h2>
                            <p><a class="btn btn-primary btn-lg btn-learn" href="{{ route('course') }}">Conhecer o Curso</a>
        ...
        <div class="container">
            <div class="row animate-box">
                <div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
                    ...
                    <p>Um treinamento completo do zero ao developer para você aprender e se especializar no Laravel e abrir
                        as portas de um mercado repleto de oportunidades!</p>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-md-pull-8 animate-box">
                        <div class="mt">
                            ...
                            <p>Confira a grade completa de aulas e aproveite para assitir algumas delas para conhecer nossa
                                metodologia.</p>
                            <ul class="list-nav">
                            ...
                            <p><a class="btn btn-primary btn-lg popup-vimeo btn-video"
                                    href="https://vimeo.com/channels/staffpicks/93951774"><i class="icon-play"></i> Assistir
                                    uma aula</a></p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4 animate-box">
                        <div class="mt">
                            ...
                            <div>
                                ...
                                <p>Trabalhe de forma mais ágil com o framework utilizando boas práticas e PSR's para ter um
                                    código padronizado.</p>
                            </div>
                            <div>
                                <h4><i class="icon-shield"></i>Projetos Reais e Soluções Reais</h4>
                                <p>Desenvolva 4 projetos para aplicar o conhecimento adquirido em uma solução de verdade.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="features">
                    ...
                    <div class="col-md-4 animate-box text-center">
                        ...
                        <p>Se em 30 dias você não estiver passado de 30% de progresso no curso e decidir que o curso não é
                            para você... Nós devolvemos seu dinheiro.</p>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row animate-box">
                    <div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
                        ...
                        <p>Confira aqui nossos últimos artigos e video aulas!<br>Conteúdo exclusivo sobre o Laravel FrameWork.
                        </p>
                    </div>
                </div>
                <div class="row">
